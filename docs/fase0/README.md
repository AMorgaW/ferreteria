...
**Siguiente paso de inventario/recepción:** autorización humana de Fase 1B.
...
Suite actual: **34 tests, OK, 16 expected failures** (INV-15 dejó de ser xfail
tras Fase 1A). El schema SQLite de 1A no cierra los xfail de autoridad,
ledger, barcodes ni recepción.
