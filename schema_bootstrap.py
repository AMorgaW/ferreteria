...
REQUIRED_COLUMNS: Tuple[Tuple[str, str, str], ...] = (
    ...
    ("compras", "inventory_command_id", "TEXT"),
    ("detalle_compras", "package_role", "TEXT DEFAULT 'BASE_UNIT'"),
    ("detalle_compras", "cantidad_presentacion", "TEXT"),
    ("detalle_compras", "supplier_alias", "TEXT"),
...
SHARED_INDEXES: Tuple[str, ...] = (
    ...
    "CREATE INDEX IF NOT EXISTS idx_supplier_alias_producto ON supplier_product_aliases(producto_local_id)",
    "CREATE INDEX IF NOT EXISTS idx_supplier_alias_proveedor ON supplier_product_aliases(proveedor_id)",
